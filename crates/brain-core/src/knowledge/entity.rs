...
//! brain-metadata side.
//!
//! See `spec/18_entities/00_purpose.md` for the canonical schema.

use serde::{Deserialize, Serialize};

use crate::knowledge::{EntityId, EntityTypeId};
...
///
/// Field semantics (spec §18/00 §"Field semantics"):
///
...
impl Entity {
    ...
    /// O(n); spec §18/00 caps aliases at 32 per entity so a linear
