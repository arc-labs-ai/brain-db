...
The `spec/` directory is **authoritative**. 17 specification documents, ~218 markdown files, ~42K lines.
...
├── brain-protocol/      Wire protocol: frame, opcodes, codec
...
Each maps to one or more spec sections; see the relevant phase doc.
